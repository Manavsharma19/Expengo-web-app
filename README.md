This project is a web application built using **React.js**, designed as a practice project to explore React's capabilities along with integration with **MySQL** for data storage. 
